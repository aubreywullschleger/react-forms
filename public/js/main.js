...
var EmailField = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: formClass },
      React.createElement('input', { className: 'form-control', onChange: this.onChange, value: this.state.value, placeholder: 'email' })
    );
  }
});
...
ReactDOM.render(React.createElement(EmailField, null), document.getElementById('form'));
